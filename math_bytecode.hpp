...
class executable_function {
 public:
  ...
  template <class ScalarType, class Unit>
  P3A_HOST_DEVICE P3A_ALWAYS_INLINE
  inline int handle_input_argument(
      ScalarType* registers,
      int input_scalar_count,
      const p3a::quantity<ScalarType, Unit>& argument) const
  {
  ...
  inline int handle_input_argument(
      ScalarType* registers,
      int input_scalar_count,
      p3a::vector3<p3a::quantity<ScalarType, Unit>> const& argument) const
  {
  ...
  inline int handle_input_argument(
      ScalarType* registers,
      int input_scalar_count,
      p3a::vector3<p3a::quantity<ScalarType, Unit>>& argument) const
  {
    return input_scalar_count;
  }
  template <class ScalarType>
  ...
  inline int handle_output_argument(
      ScalarType* registers,
      int output_scalar_count,
      p3a::quantity<ScalarType, Unit>& argument) const
  {
      ...
      p3a::vector3<p3a::quantity<ScalarType, Unit>>& argument) const
  {
    ...
    argument.x() = p3a::quantity<ScalarType, Unit>(values[0]);
    argument.y() = p3a::quantity<ScalarType, Unit>(values[1]);
    argument.z() = p3a::quantity<ScalarType, Unit>(values[2]);
    return output_scalar_count;
  }
  template <class ScalarType>
  P3A_HOST_DEVICE P3A_ALWAYS_INLINE
